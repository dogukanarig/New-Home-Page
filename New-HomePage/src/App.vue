    ...
    <nav class="flex mt-10 mx-32 h-16 justify-between items-center font-inter mb-10">
        ...
        <div>
            <ul class="flex flex-row space-x-8">
                <li><a class="hover:text-softRed text-VeryDarkBlue" href="#">Home</a></li>
                <li><a class="hover:text-softRed text-VeryDarkBlue" href="#">New</a></li>
                <li><a class="hover:text-softRed text-VeryDarkBlue" href="#">Popular</a></li>
                <li><a class="hover:text-softRed text-VeryDarkBlue" href="#">Trending</a></li>
                <li><a class="hover:text-softRed text-VeryDarkBlue" href="#">Categories</a></li>
            </ul>
        </div>
    </nav>
